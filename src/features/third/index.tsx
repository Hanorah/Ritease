  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 style={{ fontSize: "2.8rem", fontWeight: "bold", color: "#000", marginBottom: "15px" }}>
            PDF Annotation Editor
          </h1>
          <p style={{ fontSize: "1.3rem", color: "#000", marginBottom: "25px", maxWidth: "80%" }}>
            Add, preview, edit, and save annotations easily.
          </p>
          ...
          <button
            ...
            onClick={() => {
              const dropZone = document.querySelector('.uploadSection');
              if (dropZone) {
